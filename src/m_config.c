...
static default_t	doom_defaults_list[] =
{
    ...
    CONFIG_VARIABLE_INT(launcher_position_x),
    CONFIG_VARIABLE_INT(launcher_position_y),
    CONFIG_VARIABLE_INT(launcher_width_x),
    CONFIG_VARIABLE_INT(launcher_width_y),
    CONFIG_VARIABLE_STRING(launcher_default_iwad),
    CONFIG_VARIABLE_STRING(launcher_command_line),
    CONFIG_VARIABLE_COMMENT(""),
    ...
    CONFIG_VARIABLE_INT(joybtn_use),
    CONFIG_VARIABLE_INT(joybtn_strafe),
    CONFIG_VARIABLE_INT(joybtn_fire),
    CONFIG_VARIABLE_INT(joybtn_speed),
    CONFIG_VARIABLE_INT(joybtn_jump),
    CONFIG_VARIABLE_INT(joybtn_strafeleft),
    CONFIG_VARIABLE_INT(joybtn_straferight),
    CONFIG_VARIABLE_INT(joybtn_prevweapon),
    CONFIG_VARIABLE_INT(joybtn_nextweapon),
    CONFIG_VARIABLE_INT(joybtn_menu_activate),
    CONFIG_VARIABLE_INT(joybtn_toggle_automap),
    CONFIG_VARIABLE_INT(joybtn_useartifact),
    CONFIG_VARIABLE_INT(joybtn_invleft),
    CONFIG_VARIABLE_INT(joybtn_invright),
    CONFIG_VARIABLE_INT(joybtn_flyup),
    CONFIG_VARIABLE_INT(joybtn_flydown),
    CONFIG_VARIABLE_INT(joybtn_flycenter),
    CONFIG_VARIABLE_COMMENT(""),
    ...
    CONFIG_VARIABLE_INT(st_armor_value),
    ...
    CONFIG_VARIABLE_STRING(gp_revealed_secrets_msg),
    ...
    CONFIG_VARIABLE_INT(compat_auto_sr50),
    CONFIG_VARIABLE_INT(compat_intercepts),
    ...
    CONFIG_VARIABLE_INT(a11y_quake_intensity),
