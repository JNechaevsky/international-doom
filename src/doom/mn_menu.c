...
{
    { M_MUL1, "SHIMMERING HOM EFFECT",  M_ID_ShimmeringHOM,     's' },
...
static void M_Draw_ID_Keybinds_2 (void)
{
    ...
    M_DrawBindKey(7, 81, key_demospeed, key_demospeed2);
    M_DrawBindKey(8, 90, key_flip_levels, key_flip_levels2);
    M_DrawBindKey(9, 99, key_widget_enable, key_widget_enable2);

    M_WriteTextCentered(108, "SPECIAL MODES", cr[CR_YELLOW]);

    M_DrawBindKey(11, 117, key_spectator, key_spectator2);
...
static void M_Bind_Rewind (int choice)
{
    M_StartBind(303);  // key_rewind
}

static void M_Bind_Weapon1 (int choice)
{
    M_StartBind(304);  // key_weapon1
}

static void M_Bind_Weapon2 (int choice)
{
    M_StartBind(305);  // key_weapon2
}

static void M_Bind_Weapon3 (int choice)
{
    M_StartBind(306);  // key_weapon3
}

static void M_Bind_Weapon4 (int choice)
{
    M_StartBind(307);  // key_weapon4
}

static void M_Bind_Weapon5 (int choice)
{
    M_StartBind(308);  // key_weapon5
}

static void M_Bind_Weapon6 (int choice)
{
    M_StartBind(309);  // key_weapon6
}

static void M_Bind_Weapon7 (int choice)
{
    M_StartBind(310);  // key_weapon7
}

static void M_Bind_Weapon8 (int choice)
{
    M_StartBind(311);  // key_weapon8
}

static void M_Bind_PrevWeapon (int choice)
{
    M_StartBind(312);  // key_prevweapon
}

static void M_Bind_NextWeapon (int choice)
{
    M_StartBind(313);  // key_nextweapon
}
...
static void M_Draw_ID_Keybinds_3 (void)
{
    ...
    M_DrawBindKey(3, 45, key_rewind, key_rewind2);

    M_WriteTextCentered(54, "WEAPONS", cr[CR_YELLOW]);

    M_DrawBindKey(5, 63, key_weapon1, key_weapon1_2);
    M_DrawBindKey(6, 72, key_weapon2, key_weapon2_2);
    M_DrawBindKey(7, 81, key_weapon3, key_weapon3_2);
    M_DrawBindKey(8, 90, key_weapon4, key_weapon4_2);
    M_DrawBindKey(9, 99, key_weapon5, key_weapon5_2);
    M_DrawBindKey(10, 108, key_weapon6, key_weapon6_2);
    M_DrawBindKey(11, 117, key_weapon7, key_weapon7_2);
    M_DrawBindKey(12, 126, key_weapon8, key_weapon8_2);
    M_DrawBindKey(13, 135, key_prevweapon, key_prevweapon2);
    M_DrawBindKey(14, 144, key_nextweapon, key_nextweapon2);
...
static void M_Bind_FinishDemo (int choice)
{
    M_StartBind(604);  // key_demo_quit
}

static void M_Bind_SwitchOST (int choice)
{
    M_StartBind(605);  // key_switch_ost
}

static void M_Bind_SendMessage (int choice)
{
    M_StartBind(606);  // key_multi_msg
}

static void M_Bind_ToPlayer1 (int choice)
{
    M_StartBind(607);  // key_multi_msgplayer1
}

static void M_Bind_ToPlayer2 (int choice)
{
    M_StartBind(608);  // key_multi_msgplayer2
}

static void M_Bind_ToPlayer3 (int choice)
{
    M_StartBind(609);  // key_multi_msgplayer3
}

static void M_Bind_ToPlayer4 (int choice)
{
    M_StartBind(610);  // key_multi_msgplayer4
}
...
static void M_Draw_ID_Keybinds_6 (void)
{
    ...
    M_DrawBindKey(4, 54, key_demo_quit, key_demo_quit2);
    M_DrawBindKey(5, 63, key_switch_ost, key_switch_ost2);

    M_WriteTextCentered(72, "MULTIPLAYER", cr[CR_YELLOW]);

    M_DrawBindKey(7, 81, key_multi_msg, key_multi_msg2);
    M_DrawBindKey(8, 90, key_multi_msgplayer[0], key_multi_msgplayer2[0]);
    M_DrawBindKey(9, 99, key_multi_msgplayer[1], key_multi_msgplayer2[1]);
    M_DrawBindKey(10, 108, key_multi_msgplayer[2], key_multi_msgplayer2[2]);
    M_DrawBindKey(11, 117, key_multi_msgplayer[3], key_multi_msgplayer2[3]);
...
static void M_Draw_ID_Automap (void)
{
    ...
    M_WriteTextCentered(108, "MINIMAP", cr[CR_YELLOW]);
...
int M_StringWidth(const char *const string)
{
    int w = 0;
    int c;
...
static const KeyBindEntry_t keybinds[] =
{
    ...
    KEYBIND_ENTRY(206, &ID_Def_Keybinds_2, 7,  key_demospeed,     key_demospeed2,     0,            0, KBS_GLOBAL),
    KEYBIND_ENTRY(207, &ID_Def_Keybinds_2, 8,  key_flip_levels,   key_flip_levels2,   0,            0, KBS_GLOBAL),
    KEYBIND_ENTRY(208, &ID_Def_Keybinds_2, 9,  key_widget_enable, key_widget_enable2, 0,            0, KBS_GLOBAL),
    KEYBIND_ENTRY(209, &ID_Def_Keybinds_2, 11, key_spectator,     key_spectator2,     0,            0, KBS_GLOBAL),
    ...
    KEYBIND_ENTRY(303, &ID_Def_Keybinds_3, 3,  key_rewind,      key_rewind2,      0,   0, KBS_GLOBAL),
    KEYBIND_ENTRY(304, &ID_Def_Keybinds_3, 5,  key_weapon1,     key_weapon1_2,    '1', 0, KBS_GLOBAL),
    KEYBIND_ENTRY(305, &ID_Def_Keybinds_3, 6,  key_weapon2,     key_weapon2_2,    '2', 0, KBS_GLOBAL),
    KEYBIND_ENTRY(306, &ID_Def_Keybinds_3, 7,  key_weapon3,     key_weapon3_2,    '3', 0, KBS_GLOBAL),
    KEYBIND_ENTRY(307, &ID_Def_Keybinds_3, 8,  key_weapon4,     key_weapon4_2,    '4', 0, KBS_GLOBAL),
    KEYBIND_ENTRY(308, &ID_Def_Keybinds_3, 9,  key_weapon5,     key_weapon5_2,    '5', 0, KBS_GLOBAL),
    KEYBIND_ENTRY(309, &ID_Def_Keybinds_3, 10, key_weapon6,     key_weapon6_2,    '6', 0, KBS_GLOBAL),
    KEYBIND_ENTRY(310, &ID_Def_Keybinds_3, 11, key_weapon7,     key_weapon7_2,    '7', 0, KBS_GLOBAL),
    KEYBIND_ENTRY(311, &ID_Def_Keybinds_3, 12, key_weapon8,     key_weapon8_2,    '8', 0, KBS_GLOBAL),
    KEYBIND_ENTRY(312, &ID_Def_Keybinds_3, 13, key_prevweapon,  key_prevweapon2,  0,   0, KBS_GLOBAL),
    KEYBIND_ENTRY(313, &ID_Def_Keybinds_3, 14, key_nextweapon,  key_nextweapon2,  0,   0, KBS_GLOBAL),
    ...
    KEYBIND_ENTRY(510, &ID_Def_Keybinds_5, 10, key_menu_gammad,   key_menu_gammad2,   0,       0, KBS_GLOBAL),
    KEYBIND_ENTRY(511, &ID_Def_Keybinds_5, 11, key_menu_gamma,    key_menu_gamma2,    KEY_F11, 0, KBS_GLOBAL),
    KEYBIND_ENTRY(512, &ID_Def_Keybinds_5, 12, key_spy,           key_spy2,           KEY_F12, 0, KBS_GLOBAL),
    ...
    KEYBIND_ENTRY(604, &ID_Def_Keybinds_6, 4,  key_demo_quit,          key_demo_quit2,          'q',        0, KBS_GLOBAL),
    KEYBIND_ENTRY(605, &ID_Def_Keybinds_6, 5,  key_switch_ost,         key_switch_ost2,         0,          0, KBS_GLOBAL),
    KEYBIND_ENTRY(606, &ID_Def_Keybinds_6, 7,  key_multi_msg,          key_multi_msg2,          't',        0, KBS_GLOBAL),
    KEYBIND_ENTRY(607, &ID_Def_Keybinds_6, 8,  key_multi_msgplayer[0], key_multi_msgplayer2[0], 'g',        0, KBS_SENDTO_ONLY),
    KEYBIND_ENTRY(608, &ID_Def_Keybinds_6, 9,  key_multi_msgplayer[1], key_multi_msgplayer2[1], 'i',        0, KBS_SENDTO_ONLY),
    KEYBIND_ENTRY(609, &ID_Def_Keybinds_6, 10, key_multi_msgplayer[2], key_multi_msgplayer2[2], 'b',        0, KBS_SENDTO_ONLY),
    KEYBIND_ENTRY(610, &ID_Def_Keybinds_6, 11, key_multi_msgplayer[3], key_multi_msgplayer2[3], 'r',        0, KBS_SENDTO_ONLY),
};
