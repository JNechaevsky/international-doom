...
state_t	states[NUMSTATES] = {
    ...
    {SPR_SHTG,4,0,{.acp3 = (actionf_p3)A_Light0},S_NULL,0,0},	// S_LIGHTDONE
    {SPR_PUNG,0,1,{.acp3 = (actionf_p3)A_WeaponReady},S_PUNCH,0,0},	// S_PUNCH
    {SPR_PUNG,0,1,{.acp3 = (actionf_p3)A_Lower},S_PUNCHDOWN,0,0},	// S_PUNCHDOWN
    {SPR_PUNG,0,1,{.acp3 = (actionf_p3)A_Raise},S_PUNCHUP,0,0},	// S_PUNCHUP
    {SPR_PUNG,1,4,{NULL},S_PUNCH2,0,0},		// S_PUNCH1
    {SPR_PUNG,2,4,{.acp3 = (actionf_p3)A_Punch},S_PUNCH3,0,0},	// S_PUNCH2
    {SPR_PUNG,3,5,{NULL},S_PUNCH4,0,0},		// S_PUNCH3
    {SPR_PUNG,2,4,{NULL},S_PUNCH5,0,0},		// S_PUNCH4
    {SPR_PUNG,1,5,{.acp3 = (actionf_p3)A_ReFire},S_PUNCH,0,0},	// S_PUNCH5
    {SPR_PISG,0,1,{.acp3 = (actionf_p3)A_WeaponReady},S_PISTOL,0,0},// S_PISTOL
    {SPR_PISG,0,1,{.acp3 = (actionf_p3)A_Lower},S_PISTOLDOWN,0,0},	// S_PISTOLDOWN
    {SPR_PISG,0,1,{.acp3 = (actionf_p3)A_Raise},S_PISTOLUP,0,0},	// S_PISTOLUP
    {SPR_PISG,0,4,{NULL},S_PISTOL2,0,0},	// S_PISTOL1
    {SPR_PISG,1,6,{.acp3 = (actionf_p3)A_FirePistol},S_PISTOL3,0,0},// S_PISTOL2
    {SPR_PISG,2,4,{NULL},S_PISTOL4,0,0},	// S_PISTOL3
    {SPR_PISG,1,5,{.acp3 = (actionf_p3)A_ReFire},S_PISTOL,0,0},	// S_PISTOL4
    {SPR_PISF,32768,7,{.acp3 = (actionf_p3)A_Light1},S_LIGHTDONE,0,0},	// S_PISTOLFLASH
    {SPR_SHTG,0,1,{.acp3 = (actionf_p3)A_WeaponReady},S_SGUN,0,0},	// S_SGUN
    {SPR_SHTG,0,1,{.acp3 = (actionf_p3)A_Lower},S_SGUNDOWN,0,0},	// S_SGUNDOWN
    {SPR_SHTG,0,1,{.acp3 = (actionf_p3)A_Raise},S_SGUNUP,0,0},	// S_SGUNUP
    {SPR_SHTG,0,3,{NULL},S_SGUN2,0,0},	// S_SGUN1
    {SPR_SHTG,0,7,{.acp3 = (actionf_p3)A_FireShotgun},S_SGUN3,0,0},	// S_SGUN2
    ...
    {SPR_SHTG,0,7,{.acp3 = (actionf_p3)A_ReFire},S_SGUN,0,0},	// S_SGUN9
    {SPR_SHTF,32768,4,{.acp3 = (actionf_p3)A_Light1},S_SGUNFLASH2,0,0},	// S_SGUNFLASH1
    {SPR_SHTF,32769,3,{.acp3 = (actionf_p3)A_Light2},S_LIGHTDONE,0,0},	// S_SGUNFLASH2
    {SPR_SHT2,0,1,{.acp3 = (actionf_p3)A_WeaponReady},S_DSGUN,0,0},	// S_DSGUN
    {SPR_SHT2,0,1,{.acp3 = (actionf_p3)A_Lower},S_DSGUNDOWN,0,0},	// S_DSGUNDOWN
    {SPR_SHT2,0,1,{.acp3 = (actionf_p3)A_Raise},S_DSGUNUP,0,0},	// S_DSGUNUP
    {SPR_SHT2,0,3,{NULL},S_DSGUN2,0,0},	// S_DSGUN1
    // [JN] killough 9/5/98: make SSG lighting flash more uniform along super shotgun:
    {SPR_SHT2,32768,7,{.acp3 = (actionf_p3)A_FireShotgun2},S_DSGUN3}, // S_DSGUN2
    {SPR_SHT2,1,7,{NULL},S_DSGUN4,0,0},	// S_DSGUN3
    {SPR_SHT2,2,7,{.acp3 = (actionf_p3)A_CheckReload},S_DSGUN5,0,0},	// S_DSGUN4
    {SPR_SHT2,3,7,{.acp3 = (actionf_p3)A_OpenShotgun2},S_DSGUN6,0,0},	// S_DSGUN5
    {SPR_SHT2,4,7,{NULL},S_DSGUN7,0,0},	// S_DSGUN6
    {SPR_SHT2,5,7,{.acp3 = (actionf_p3)A_LoadShotgun2},S_DSGUN8,0,0},	// S_DSGUN7
    {SPR_SHT2,6,6,{NULL},S_DSGUN9,0,0},	// S_DSGUN8
    {SPR_SHT2,7,6,{.acp3 = (actionf_p3)A_CloseShotgun2},S_DSGUN10,0,0},	// S_DSGUN9
    {SPR_SHT2,0,5,{.acp3 = (actionf_p3)A_ReFire},S_DSGUN,0,0},	// S_DSGUN10
    {SPR_SHT2,1,7,{NULL},S_DSNR2,0,0},	// S_DSNR1
    {SPR_SHT2,0,3,{NULL},S_DSGUNDOWN,0,0},	// S_DSNR2
    // [JN] killough 8/20/98: reduce first SSG flash frame one tic, to fix
    // Doom II SSG flash bug, in which SSG raises before flash finishes
    {SPR_SHT2,32776,4,{.acp3 = (actionf_p3)A_Light1},S_DSGUNFLASH2,0,0},	// S_DSGUNFLASH1
    {SPR_SHT2,32777,4,{.acp3 = (actionf_p3)A_Light2},S_LIGHTDONE,0,0},	// S_DSGUNFLASH2
    {SPR_CHGG,0,1,{.acp3 = (actionf_p3)A_WeaponReady},S_CHAIN,0,0},	// S_CHAIN
    {SPR_CHGG,0,1,{.acp3 = (actionf_p3)A_Lower},S_CHAINDOWN,0,0},	// S_CHAINDOWN
    {SPR_CHGG,0,1,{.acp3 = (actionf_p3)A_Raise},S_CHAINUP,0,0},	// S_CHAINUP
    {SPR_CHGG,0,4,{.acp3 = (actionf_p3)A_FireCGun},S_CHAIN2,0,0},	// S_CHAIN1
    {SPR_CHGG,1,4,{.acp3 = (actionf_p3)A_FireCGun},S_CHAIN3,0,0},	// S_CHAIN2
    {SPR_CHGG,1,0,{.acp3 = (actionf_p3)A_ReFire},S_CHAIN,0,0},	// S_CHAIN3
    {SPR_CHGF,32768,5,{.acp3 = (actionf_p3)A_Light1},S_LIGHTDONE,0,0},	// S_CHAINFLASH1
    {SPR_CHGF,32769,5,{.acp3 = (actionf_p3)A_Light2},S_LIGHTDONE,0,0},	// S_CHAINFLASH2
    {SPR_MISG,0,1,{.acp3 = (actionf_p3)A_WeaponReady},S_MISSILE,0,0},	// S_MISSILE
    {SPR_MISG,0,1,{.acp3 = (actionf_p3)A_Lower},S_MISSILEDOWN,0,0},	// S_MISSILEDOWN
    {SPR_MISG,0,1,{.acp3 = (actionf_p3)A_Raise},S_MISSILEUP,0,0},	// S_MISSILEUP
    {SPR_MISG,1,8,{.acp3 = (actionf_p3)A_GunFlash},S_MISSILE2,0,0},	// S_MISSILE1
    {SPR_MISG,1,12,{.acp3 = (actionf_p3)A_FireMissile},S_MISSILE3,0,0},	// S_MISSILE2
    {SPR_MISG,1,0,{.acp3 = (actionf_p3)A_ReFire},S_MISSILE,0,0},	// S_MISSILE3
    {SPR_MISF,32768,3,{.acp3 = (actionf_p3)A_Light1},S_MISSILEFLASH2,0,0},	// S_MISSILEFLASH1
    {SPR_MISF,32769,4,{NULL},S_MISSILEFLASH3,0,0},	// S_MISSILEFLASH2
    {SPR_MISF,32770,4,{.acp3 = (actionf_p3)A_Light2},S_MISSILEFLASH4,0,0},	// S_MISSILEFLASH3
    {SPR_MISF,32771,4,{.acp3 = (actionf_p3)A_Light2},S_LIGHTDONE,0,0},	// S_MISSILEFLASH4
    {SPR_SAWG,2,4,{.acp3 = (actionf_p3)A_WeaponReady},S_SAWB,0,0},	// S_SAW
    {SPR_SAWG,3,4,{.acp3 = (actionf_p3)A_WeaponReady},S_SAW,0,0},	// S_SAWB
    {SPR_SAWG,2,1,{.acp3 = (actionf_p3)A_Lower},S_SAWDOWN,0,0},	// S_SAWDOWN
    {SPR_SAWG,2,1,{.acp3 = (actionf_p3)A_Raise},S_SAWUP,0,0},	// S_SAWUP
    {SPR_SAWG,0,4,{.acp3 = (actionf_p3)A_Saw},S_SAW2,0,0},	// S_SAW1
    {SPR_SAWG,1,4,{.acp3 = (actionf_p3)A_Saw},S_SAW3,0,0},	// S_SAW2
    {SPR_SAWG,1,0,{.acp3 = (actionf_p3)A_ReFire},S_SAW,0,0},	// S_SAW3
    {SPR_PLSG,0,1,{.acp3 = (actionf_p3)A_WeaponReady},S_PLASMA,0,0},	// S_PLASMA
    {SPR_PLSG,0,1,{.acp3 = (actionf_p3)A_Lower},S_PLASMADOWN,0,0},	// S_PLASMADOWN
    {SPR_PLSG,0,1,{.acp3 = (actionf_p3)A_Raise},S_PLASMAUP,0,0},	// S_PLASMAUP
    {SPR_PLSG,0,3,{.acp3 = (actionf_p3)A_FirePlasma},S_PLASMA2,0,0},	// S_PLASMA1
    {SPR_PLSG,1,20,{.acp3 = (actionf_p3)A_ReFire},S_PLASMA,0,0},	// S_PLASMA2
    {SPR_PLSF,32768,4,{.acp3 = (actionf_p3)A_Light1},S_LIGHTDONE,0,0},	// S_PLASMAFLASH1
    {SPR_PLSF,32769,4,{.acp3 = (actionf_p3)A_Light1},S_LIGHTDONE,0,0},	// S_PLASMAFLASH2
    {SPR_BFGG,0,1,{.acp3 = (actionf_p3)A_WeaponReady},S_BFG,0,0},	// S_BFG
    {SPR_BFGG,0,1,{.acp3 = (actionf_p3)A_Lower},S_BFGDOWN,0,0},	// S_BFGDOWN
    {SPR_BFGG,0,1,{.acp3 = (actionf_p3)A_Raise},S_BFGUP,0,0},	// S_BFGUP
    {SPR_BFGG,0,20,{.acp3 = (actionf_p3)A_BFGsound},S_BFG2,0,0},	// S_BFG1
    {SPR_BFGG,1,10,{.acp3 = (actionf_p3)A_GunFlash},S_BFG3,0,0},	// S_BFG2
    {SPR_BFGG,1,10,{.acp3 = (actionf_p3)A_FireBFG},S_BFG4,0,0},	// S_BFG3
    {SPR_BFGG,1,20,{.acp3 = (actionf_p3)A_ReFire},S_BFG,0,0},	// S_BFG4
    {SPR_BFGF,32768,11,{.acp3 = (actionf_p3)A_Light1},S_BFGFLASH2,0,0},	// S_BFGFLASH1
    {SPR_BFGF,32769,6,{.acp3 = (actionf_p3)A_Light2},S_LIGHTDONE,0,0},	// S_BFGFLASH2
    ...
    {SPR_POSS,5|0x8000,8,{.acp1 = (actionf_p1)A_PosAttack},S_POSS_ATK3,0,0},	// S_POSS_ATK2
    ...
    {SPR_CPOS,5|0x8000,1,{.acp1 = (actionf_p1)A_CPosRefire},S_CPOS_ATK2,0,0},	// S_CPOS_ATK4
    ...
    {SPR_CYBR,5|0x8000,12,{.acp1 = (actionf_p1)A_CyberAttack},S_CYBER_ATK3,0,0},	// S_CYBER_ATK2
    {SPR_CYBR,4,12,{.acp1 = (actionf_p1)A_FaceTarget},S_CYBER_ATK4,0,0},	// S_CYBER_ATK3
    {SPR_CYBR,5|0x8000,12,{.acp1 = (actionf_p1)A_CyberAttack},S_CYBER_ATK5,0,0},	// S_CYBER_ATK4
    {SPR_CYBR,4,12,{.acp1 = (actionf_p1)A_FaceTarget},S_CYBER_ATK6,0,0},	// S_CYBER_ATK5
    {SPR_CYBR,5|0x8000,12,{.acp1 = (actionf_p1)A_CyberAttack},S_CYBER_RUN1,0,0},	// S_CYBER_ATK6
    ...
    {SPR_MISL,32768,1000,{.acp1 = (actionf_p1)A_Die},S_GRENADE,0,0},	// S_GRENADE
    {SPR_MISL,32769,4,{.acp1 = (actionf_p1)A_Scream},S_DETONATE2,0,0},	// S_DETONATE
    {SPR_MISL,32770,6,{.acp1 = (actionf_p1)A_Detonate},S_DETONATE3,0,0},	// S_DETONATE2
    {SPR_MISL,32771,10,{NULL},S_NULL,0,0},	// S_DETONATE3
    {SPR_DOGS,0,10,{.acp1 = (actionf_p1)A_Look},S_DOGS_STND2,0,0},	// S_DOGS_STND
    {SPR_DOGS,1,10,{.acp1 = (actionf_p1)A_Look},S_DOGS_STND,0,0},	// S_DOGS_STND2
    {SPR_DOGS,0,2,{.acp1 = (actionf_p1)A_Chase},S_DOGS_RUN2,0,0},	// S_DOGS_RUN1
    {SPR_DOGS,0,2,{.acp1 = (actionf_p1)A_Chase},S_DOGS_RUN3,0,0},	// S_DOGS_RUN2
    {SPR_DOGS,1,2,{.acp1 = (actionf_p1)A_Chase},S_DOGS_RUN4,0,0},	// S_DOGS_RUN3
    {SPR_DOGS,1,2,{.acp1 = (actionf_p1)A_Chase},S_DOGS_RUN5,0,0},	// S_DOGS_RUN4
    {SPR_DOGS,2,2,{.acp1 = (actionf_p1)A_Chase},S_DOGS_RUN6,0,0},	// S_DOGS_RUN5
    {SPR_DOGS,2,2,{.acp1 = (actionf_p1)A_Chase},S_DOGS_RUN7,0,0},	// S_DOGS_RUN6
    {SPR_DOGS,3,2,{.acp1 = (actionf_p1)A_Chase},S_DOGS_RUN8,0,0},	// S_DOGS_RUN7
    {SPR_DOGS,3,2,{.acp1 = (actionf_p1)A_Chase},S_DOGS_RUN1,0,0},	// S_DOGS_RUN8
    {SPR_DOGS,4,8,{.acp1 = (actionf_p1)A_FaceTarget},S_DOGS_ATK2,0,0},	// S_DOGS_ATK1
    {SPR_DOGS,5,8,{.acp1 = (actionf_p1)A_FaceTarget},S_DOGS_ATK3,0,0},	// S_DOGS_ATK2
    {SPR_DOGS,6,8,{.acp1 = (actionf_p1)A_SargAttack},S_DOGS_RUN1,0,0},	// S_DOGS_ATK3
    {SPR_DOGS,7,2,{NULL},S_DOGS_PAIN2,0,0},	// S_DOGS_PAIN
    {SPR_DOGS,7,2,{.acp1 = (actionf_p1)A_Pain},S_DOGS_RUN1,0,0},	// S_DOGS_PAIN2
    {SPR_DOGS,8,8,{NULL},S_DOGS_DIE2,0,0},	// S_DOGS_DIE1
    {SPR_DOGS,9,8,{.acp1 = (actionf_p1)A_Scream},S_DOGS_DIE3,0,0},	// S_DOGS_DIE2
    {SPR_DOGS,10,4,{NULL},S_DOGS_DIE4,0,0},	// S_DOGS_DIE3
    {SPR_DOGS,11,4,{.acp1 = (actionf_p1)A_Fall},S_DOGS_DIE5,0,0},	// S_DOGS_DIE4
...
#define BFGDELAY 1
#define OLDBFG_1FRAMES(x) {SPR_BFGG,1,BFGDELAY,{.acp1 = (actionf_p1)A_FireOldBFG},x+S_OLDBFG1+2,0,0},
...
#define OLDBFG_8FRAMES(x) OLDBFG_4FRAMES(x) OLDBFG_4FRAMES(x+4)
    ...
    OLDBFG_8FRAMES(24)
    OLDBFG_8FRAMES(32)
    {SPR_BFGG,1,0,{.acp3 = (actionf_p3)A_Light0},S_OLDBFG43,0,0},	// S_OLDBFG42
    {SPR_BFGG,1,20,{.acp3 = (actionf_p3)A_ReFire},S_BFG,0,0},	// S_OLDBFG43
    ...
    {SPR_SKUL,0,10,{.acp1 = (actionf_p1)A_Look},S_BSKUL_STND,0,0},	// S_BSKUL_STND
    {SPR_SKUL,1,5,{.acp1 = (actionf_p1)A_Chase},S_BSKUL_RUN2,0,0},	// S_BSKUL_RUN1
    {SPR_SKUL,2,5,{.acp1 = (actionf_p1)A_Chase},S_BSKUL_RUN3,0,0},	// S_BSKUL_RUN2
    {SPR_SKUL,3,5,{.acp1 = (actionf_p1)A_Chase},S_BSKUL_RUN4,0,0},	// S_BSKUL_RUN3
    {SPR_SKUL,0,5,{.acp1 = (actionf_p1)A_Chase},S_BSKUL_RUN1,0,0},	// S_BSKUL_RUN4
    {SPR_SKUL,4,4,{.acp1 = (actionf_p1)A_FaceTarget},S_BSKUL_ATK2,0,0},	// S_BSKUL_ATK1
    {SPR_SKUL,5,5,{.acp1 = (actionf_p1)A_BetaSkullAttack},S_BSKUL_ATK3,0,0},	// S_BSKUL_ATK2
    {SPR_SKUL,5,4,{NULL},S_BSKUL_RUN1,0,0},	// S_BSKUL_ATK3
    {SPR_SKUL,6,4,{NULL},S_BSKUL_PAIN2,0,0},	// S_BSKUL_PAIN1
    {SPR_SKUL,7,2,{.acp1 = (actionf_p1)A_Pain},S_BSKUL_RUN1,0,0},	// S_BSKUL_PAIN2
    ...
    {SPR_SKUL,13,5,{.acp1 = (actionf_p1)A_Scream},S_BSKUL_DIE6,0,0},	// S_BSKUL_DIE5
    {SPR_SKUL,14,5,{NULL},S_BSKUL_DIE7,0,0},	// S_BSKUL_DIE6
    {SPR_SKUL,15,5,{.acp1 = (actionf_p1)A_Fall},S_BSKUL_DIE8,0,0},	// S_BSKUL_DIE7
    {SPR_SKUL,16,5,{.acp1 = (actionf_p1)A_Stop},S_BSKUL_DIE8,0,0},	// S_BSKUL_DIE8
    {SPR_MISL,32769,8,{.acp1 = (actionf_p1)A_Mushroom},S_EXPLODE2,0,0},	// S_MUSHROOM
};
