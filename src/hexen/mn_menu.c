...
inline static void M_ID_MenuMouseControl (void)
{
    ...
    for (int i = 0; i < CurrentMenu->itemCount; ++i)
    {
        ...
        const int lines = (CurrentMenu->items[i].type == ITT_SLDR) ? 3 : 1;
...
#define UNSET_IF_MATCH(k, a, b)  do { if ((a) == (k)) (a) = 0; if ((b) == (k)) (b) = 0; } while (0)
    ...
    UNSET_IF_MATCH(key, key_jump, key_jump2);
    ...
    UNSET_IF_MATCH(key, key_arti_health, key_arti_health2);
    UNSET_IF_MATCH(key, key_arti_urn, key_arti_urn2);
    UNSET_IF_MATCH(key, key_arti_poisonbag, key_arti_poisonbag2);
    UNSET_IF_MATCH(key, key_arti_blastradius, key_arti_blastradius2);
    UNSET_IF_MATCH(key, key_arti_invulnerability, key_arti_invulnerability2);
    
    // Page 5
    UNSET_IF_MATCH(key, key_arti_egg, key_arti_egg2);
    UNSET_IF_MATCH(key, key_arti_teleport, key_arti_teleport2);
    UNSET_IF_MATCH(key, key_arti_teleportother, key_arti_teleportother2);
    UNSET_IF_MATCH(key, key_arti_wings, key_arti_wings2);
    UNSET_IF_MATCH(key, key_arti_servant, key_arti_servant2);
    UNSET_IF_MATCH(key, key_arti_bracers, key_arti_bracers2);
    UNSET_IF_MATCH(key, key_arti_boots, key_arti_boots2);
    UNSET_IF_MATCH(key, key_arti_torch, key_arti_torch2);
    UNSET_IF_MATCH(key, key_arti_krater, key_arti_krater2);
    UNSET_IF_MATCH(key, key_arti_incant, key_arti_incant2);
    UNSET_IF_MATCH(key, key_arti_all, key_arti_all2);
...
static void M_DoBind (int keynum, int key)
{
    switch (keynum)
    {
        ...
        case 106: M_DoBindAction(&key_strafe,      &key_strafe2,      key, keyboard); break;
        case 107: M_DoBindAction(&key_speed,       &key_speed2,       key, keyboard); break;
        case 108: M_DoBindAction(&key_jump,        &key_jump2,        key, keyboard); break;
        case 109: M_DoBindAction(&key_180turn,     &key_180turn2,     key, keyboard); break;
        case 110: M_DoBindAction(&key_fire,        &key_fire2,        key, keyboard); break;
        case 111: M_DoBindAction(&key_use,         &key_use2,         key, keyboard); break;
        ...
        case 404: M_DoBindAction(&key_prevweapon,           &key_prevweapon2,           key, keyboard); break;
        case 405: M_DoBindAction(&key_nextweapon,           &key_nextweapon2,           key, keyboard); break;
        case 406: M_DoBindAction(&key_arti_health,          &key_arti_health2,          key, keyboard); break;
        case 407: M_DoBindAction(&key_arti_urn,             &key_arti_urn2,             key, keyboard); break;
        case 408: M_DoBindAction(&key_arti_poisonbag,       &key_arti_poisonbag2,       key, keyboard); break;
        case 409: M_DoBindAction(&key_arti_blastradius,     &key_arti_blastradius2,     key, keyboard); break;
        case 410: M_DoBindAction(&key_arti_invulnerability, &key_arti_invulnerability2, key, keyboard); break;
        
        // Page 5
        case 500: M_DoBindAction(&key_arti_egg,           &key_arti_egg2,           key, keyboard); break;
        case 501: M_DoBindAction(&key_arti_teleport,      &key_arti_teleport2,      key, keyboard); break;
        case 502: M_DoBindAction(&key_arti_teleportother, &key_arti_teleportother2, key, keyboard); break;
        case 503: M_DoBindAction(&key_arti_wings,         &key_arti_wings2,         key, keyboard); break;
        case 504: M_DoBindAction(&key_arti_servant,       &key_arti_servant2,       key, keyboard); break;
        case 505: M_DoBindAction(&key_arti_bracers,       &key_arti_bracers2,       key, keyboard); break;
        case 506: M_DoBindAction(&key_arti_boots,         &key_arti_boots2,         key, keyboard); break;
        case 507: M_DoBindAction(&key_arti_torch,         &key_arti_torch2,         key, keyboard); break;
        case 508: M_DoBindAction(&key_arti_krater,        &key_arti_krater2,        key, keyboard); break;
        case 509: M_DoBindAction(&key_arti_incant,        &key_arti_incant2,        key, keyboard); break;
        case 510: M_DoBindAction(&key_arti_all,           &key_arti_all2,           key, keyboard); break;
        ...
        case 710: M_DoBindAction(&key_menu_gammad,   &key_menu_gammad2,   key, keyboard); break;
        case 711: M_DoBindAction(&key_menu_gamma,    &key_menu_gamma2,    key, keyboard); break;
        case 712: M_DoBindAction(&key_spy,           &key_spy2,           key, keyboard); break;
        ...
        case 806: M_DoBindAction(&key_multi_msgplayer[0], &key_multi_msgplayer[0],  key, keyboard); break;
        case 807: M_DoBindAction(&key_multi_msgplayer[1], &key_multi_msgplayer[1],  key, keyboard); break;
        case 808: M_DoBindAction(&key_multi_msgplayer[2], &key_multi_msgplayer[2],  key, keyboard); break;
        case 809: M_DoBindAction(&key_multi_msgplayer[3], &key_multi_msgplayer[3],  key, keyboard); break;
    }
}
...
static void M_ClearBind (int CurrentItPos)
{
    ...
    static KeyBindEntry_t keybinds[] = {
        ...
        { &ID_Def_Keybinds_1, 8,  &key_jump,        &key_jump2 },
        { &ID_Def_Keybinds_1, 9,  &key_180turn,     &key_180turn2 },
        { &ID_Def_Keybinds_1, 11, &key_fire,        &key_fire2 },
        { &ID_Def_Keybinds_1, 12, &key_use,         &key_use2 },
        ...
        { &ID_Def_Keybinds_4, 4,  &key_prevweapon,           &key_prevweapon2 },
        { &ID_Def_Keybinds_4, 5,  &key_nextweapon,           &key_nextweapon2 },
        { &ID_Def_Keybinds_4, 7,  &key_arti_health,          &key_arti_health2 },
        { &ID_Def_Keybinds_4, 8,  &key_arti_urn,             &key_arti_urn2 },
        { &ID_Def_Keybinds_4, 9,  &key_arti_poisonbag,       &key_arti_poisonbag2 },
        { &ID_Def_Keybinds_4, 10, &key_arti_blastradius,     &key_arti_blastradius2 },
        { &ID_Def_Keybinds_4, 11, &key_arti_invulnerability, &key_arti_invulnerability2 },

        { &ID_Def_Keybinds_5, 0,  &key_arti_egg,           &key_arti_egg2 },
        { &ID_Def_Keybinds_5, 1,  &key_arti_teleport,      &key_arti_teleport2 },
        { &ID_Def_Keybinds_5, 2,  &key_arti_teleportother, &key_arti_teleportother2 },
        { &ID_Def_Keybinds_5, 3,  &key_arti_wings,         &key_arti_wings2 },
        { &ID_Def_Keybinds_5, 4,  &key_arti_servant,       &key_arti_servant2 },
        { &ID_Def_Keybinds_5, 5,  &key_arti_bracers,       &key_arti_bracers2 },
        { &ID_Def_Keybinds_5, 6,  &key_arti_boots,         &key_arti_boots2 },
        { &ID_Def_Keybinds_5, 7,  &key_arti_torch,         &key_arti_torch2 },
        { &ID_Def_Keybinds_5, 8,  &key_arti_krater,        &key_arti_krater2 },
        { &ID_Def_Keybinds_5, 9,  &key_arti_incant,        &key_arti_incant2 },
        { &ID_Def_Keybinds_5, 10, &key_arti_all,           &key_arti_all2 },
        ...
        { &ID_Def_Keybinds_7, 10, &key_menu_gammad,   &key_menu_gammad2 },
        { &ID_Def_Keybinds_7, 11, &key_menu_gamma,    &key_menu_gamma2 },
        { &ID_Def_Keybinds_7, 12, &key_spy,           &key_spy2 },
...
static void M_ResetBinds (void)
{
    ...
    key_arti_health          = '\\'; key_arti_health2          = 0;
    key_arti_urn             = 0;    key_arti_urn2             = 0;
    key_arti_poisonbag       = '0';  key_arti_poisonbag2       = 0;
    key_arti_blastradius     = '9';  key_arti_blastradius2     = 0;
    key_arti_invulnerability = '5';  key_arti_invulnerability2 = 0;

    // Page 5
    key_arti_egg           = '6';           key_arti_egg2           = 0;
    key_arti_teleport      = '8';           key_arti_teleport2      = 0;
    key_arti_teleportother = '7';           key_arti_teleportother2 = 0;
    key_arti_wings         = 0;             key_arti_wings2         = 0;
    key_arti_servant       = 0;             key_arti_servant2       = 0;
    key_arti_bracers       = 0;             key_arti_bracers2       = 0;
    key_arti_boots         = 0;             key_arti_boots2         = 0;
    key_arti_torch         = 0;             key_arti_torch2         = 0;
    key_arti_krater        = 0;             key_arti_krater2        = 0;
    key_arti_incant        = 0;             key_arti_incant2        = 0;
    key_arti_all           = KEY_BACKSPACE; key_arti_all2           = 0;

    // Page 6
    key_map_toggle    = KEY_TAB; key_map_toggle2    = 0;
    key_map_zoomin    = '=';     key_map_zoomin2    = 0;
...
#define UNSET_IF_MATCH(k, a, b)  do { if ((a) == (k)) (a) = -1; if ((b) == (k)) (b) = -1; } while (0)
    ...
    UNSET_IF_MATCH(btn, mousebjump,        mousebjump2);
...
static void M_DoMouseBind (int btnnum, int btn)
{
    switch (btnnum)
    {
        ...
        case 1004:  M_DoBindAction(&mousebjump,        &mousebjump2,        btn, mouse);  break;
        case 1005:  M_DoBindAction(&mousebspeed,       &mousebspeed2,       btn, mouse);  break;
        case 1006:  M_DoBindAction(&mousebstrafe,      &mousebstrafe2,      btn, mouse);  break;
        case 1007:  M_DoBindAction(&mousebstrafeleft,  &mousebstrafeleft2,  btn, mouse);  break;
        case 1008:  M_DoBindAction(&mousebstraferight, &mousebstraferight2, btn, mouse);  break;
        case 1009:  M_DoBindAction(&mousebprevweapon,  &mousebprevweapon2,  btn, mouse);  break;
        case 1010:  M_DoBindAction(&mousebnextweapon,  &mousebnextweapon2,  btn, mouse);  break;
        case 1011:  M_DoBindAction(&mousebinvleft,     &mousebinvleft2,     btn, mouse);  break;
        case 1012:  M_DoBindAction(&mousebinvright,    &mousebinvright2,    btn, mouse);  break;
        case 1013:  M_DoBindAction(&mousebuseartifact, &mousebuseartifact2, btn, mouse);  break;
    }
}
...
static void M_ClearMouseBind (int itemOn)
{
    switch (itemOn)
    {
        ...
        case 4:   mousebjump        = mousebjump2        = -1; break;        
        case 5:   mousebspeed       = mousebspeed2       = -1; break;
        case 6:   mousebstrafe      = mousebstrafe2      = -1; break;
        case 7:   mousebstrafeleft  = mousebstrafeleft2  = -1; break;
        case 8:   mousebstraferight = mousebstraferight2 = -1; break;
        case 9:   mousebprevweapon  = mousebprevweapon2  = -1; break;
        case 10:  mousebnextweapon  = mousebnextweapon2  = -1; break;
        case 11:  mousebinvleft     = mousebinvleft2     = -1; break;
        case 12:  mousebinvright    = mousebinvright2    = -1; break;
        case 13:  mousebuseartifact = mousebuseartifact2 = -1; break;
    }
}
